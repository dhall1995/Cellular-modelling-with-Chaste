                                                                                            ...
                                                                                            AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    ...
    if(p_cell_A->GetCellProliferativeType()->template IsType<TrophectodermCellProliferativeType>())
    {
       ...
       if(p_cell_B->GetCellProliferativeType()->template IsType<TrophectodermCellProliferativeType>())
       {
            ...
            {
               potential_gradient = exp(-d_A1_B1/5.0)*unit_vector_from_A_to_B/5.0;
               potential_gradient_repulsion = -exp(-d_A1_B1)*unit_vector_from_A_to_B;
            ...
            {
               potential_gradient = exp(-d_A1_B2/5.0)*unit_vector_from_A_to_B/5.0;
               potential_gradient_repulsion = -exp(-d_A1_B2)*unit_vector_from_A_to_B;
            ...
            {
               potential_gradient = exp(-d_A2_B1/5.0)*unit_vector_from_A_to_B/5.0;
               potential_gradient_repulsion = -exp(-d_A2_B1)*unit_vector_from_A_to_B;
            ...
            {
               potential_gradient = exp(-d_A2_B2/5.0)*unit_vector_from_A_to_B/5.0;
               potential_gradient_repulsion = -exp(-d_A2_B2)*unit_vector_from_A_to_B;
