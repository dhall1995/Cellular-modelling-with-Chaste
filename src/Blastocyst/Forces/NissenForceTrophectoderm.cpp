                                                                                            ...
                                                                                            AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    ...
    if(p_cell_A->GetCellProliferativeType()->template IsType<TrophectodermCellProliferativeType>())
    {
       ...
       if(p_cell_B->GetCellProliferativeType()->template IsType<TrophectodermCellProliferativeType>())
       {
            ...
            double max_A1 = std::max(d_A1_B1, d_A1_B2);
            double min_A2 = std::min(d_A2_B1, d_A2_B2);
            double max_A2 = std::max(d_A2_B1, d_A2_B2);
            double minimum1;
            double minimum2;
            if(min_A1 < min_A2)
            {
            ...
            if((d_A1_B1 == minimum1 || d_A1_B1 == minimum2) && d_A1_B1 < this->GetCutOffLength())
            ...
            if((d_A1_B2 == minimum1 || d_A1_B2 == minimum2) && d_A1_B2 < this->GetCutOffLength())
            ...
            if((d_A2_B1 == minimum1 || d_A2_B1 == minimum2) && d_A2_B1 < this->GetCutOffLength())
            ...
            if((d_A2_B2 == minimum1 || d_A2_B2 == minimum2) && d_A2_B2 < this->GetCutOffLength())
