...
#ifndef PRECELLPROLIFERATIVETYPEWRITER_HPP_
#define PRECELLPROLIFERATIVETYPEWRITER_HPP_
...
/**
 * A class written using the visitor pattern for writing PrE property cells to file.
 *
 ...
 * the VTK cell data "PrE Cells" by default.
 */
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
class PrECellProliferativeTypeWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
public:
     ...
     * Default constructor.
     */
    PrECellProliferativeTypeWriter();
...
#endif /* PRECELLPROLIFERATIVETYPEWRITER_HPP_ */
